...
public class Circle extends AbstractShape {
   ...
   * @param xAxis x coordinate of the center of this circle
   * @param yAxis y coordinate of the center of this circle
   * @param radius the radius of this circle
   */
  public Circle(double xAxis, double yAxis, double radius) {
